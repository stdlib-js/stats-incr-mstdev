...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-incr-mstdev/tags). For example,

```javascript
incrmstdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mstdev@v0.1.0-umd/browser.js' )
```
