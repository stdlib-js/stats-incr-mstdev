...
```javascript
import incrmstdev from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mstdev@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-mstdev/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/stats-incr-mstdev/actions/workflows/test.yml?query=branch:v0.2.3
